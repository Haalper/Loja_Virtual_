...
protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response,
	 ...
	 if (failed instanceof BadCredentialsException) { //se a classe de falha (AuthenticationException) é uma instancia da classe de erro de login (BadCredentialsException)
			response.getWriter().write("User e senha não encontrado");
		}else { //senão (ou seja, se for outro tipo de erro) - enviaremos outro tipo de mensagem ao cliente
